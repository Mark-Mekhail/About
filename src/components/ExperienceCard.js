 ...
 */
export default function ExperienceCard({ role, company, description, logo, headingRef, headingHeight }) {
  return (
    <div className="experience-card">
      <p>{description}</p>
      <div ref={headingRef} className="heading" style={{ height: headingHeight }}>
        <div className="info">
          <h5>{role}</h5>
