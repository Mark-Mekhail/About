...
const experiences = [
  {
    ...
    company: "Shopify",
    description: "On the Talent Systems development team at Shopify, I contributed to the implementation of Shopify's custom-made tools for hiring, performance management, and compensation.",
    logo: { src: shopifyLogo, alt: "Shopify Logo" }
  },
  {
    role: "Software Engineer",
    company: "Amazon",
