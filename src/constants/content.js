...
const abouts = [
  ...
  const skillsets = [
    {
      ...
      skills: [
        ...
        { name: "SystemVerilog", icon: { src: processor, alt: "SystemVerilog Icon" } },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "GitHub Actions", icon: { src: github, alt: "GitHub Actions Icon" } },
    ...
    },
    {
      ...
      skills: [
        { name: "Data Structures", icon: { src: dataStructure, alt: "Data Structures Icon" } },
        { name: "Algorithms", icon: { src: algorithm, alt: "Algorithms Icon" } },
        { name: "Object-Oriented Programming", icon: { src: oop, alt: "OOP Icon" } },
        { name: "Multithreaded Programming", icon: { src: split, alt: "Multithreaded Programming Icon" } },
        { name: "Computer Networking", icon: { src: computerNetwork, alt: "Computer Networking Icon" } },
        { name: "Distributed Systems", icon: { src: distributedSystem, alt: "Distributed Systems Icon" } },
        { name: "REST APIs", icon: { src: restApi, alt: "REST APIs Icon" } },
        { name: "Machine Learning", icon: { src: ml, alt: "Machine Learning Icon" } },
        { name: "Cybersecurity", icon: { src: cybersecurity, alt: "Cybersecurity Icon" } },
      ],
    },
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      tags: ["Object-Oriented Programming", "Java", "JUnit", "Concurrent Programming"],
    },
  ];
